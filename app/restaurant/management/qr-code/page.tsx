  ...
  return (
    <section className={styles.qr_code}>
      ...
      <div className={styles.top}>
        <Image
          src={getSafeImageSrc(qrData.qr_code)}
          width={100}
          height={100}
          alt={qrData.business_name + " QR Code"}
          quality={100}
        />
        <div className={styles.right}>
          <div className={styles.inner_left}>
            <p>Restaurant name: {qrData.business_name}</p>
            {/* <p>ID: #0243</p> */}
            <UloDineCopyText
              text={`Url: ${qrData.restaurant_url}`}
              textToCopy={qrData.restaurant_url}
            />
          </div>
          <div className={styles.inner_right}>
            ...
            <div className={styles.buttons}>
              <UloDIneButton
                color="green"
                label="PDF"
                onClick={() => downloadAsset(qrData.pdfPath, "pdf")}
                type="secondary"
              />
              <UloDIneButton
                color="green"
